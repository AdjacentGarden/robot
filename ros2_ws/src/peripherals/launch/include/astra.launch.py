...
def generate_launch_description():
    ...
    # Define the ComposableNode
        ...
        compose_node = ComposableNode(
            ...
            parameters=parameters,
            remappings=[
                        ('/depth_cam/color/camera_info', '/depth_cam/rgb/camera_info'),
                        ('/depth_cam/color/image_raw', '/depth_cam/rgb/image_raw'),
                        ('/depth_cam/color/image_raw/compressed', '/depth_cam/rgb/image_raw/compressed'),
                        ('/depth_cam/color/image_raw/compressedDepth', '/depth_cam/rgb/image_raw/compressedDepth'),
                        ('/depth_cam/depth/color/points', '/depth_cam/depth_registered/points'),
                        ]
        )
