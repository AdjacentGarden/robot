...
def generate_launch_description():
    ...
    if compiled == 'True':
        ...
        jetacker_description_package_path = os.path.join(home, 'ros2_ws/src/simulations/jetacker_description')
        robot_controller_package_path = os.path.join(home, 'ros2_ws/src/driver/ros_robot_controller')
        controller_package_path = os.path.join(home, 'ros2_ws/src/driver/controller')
