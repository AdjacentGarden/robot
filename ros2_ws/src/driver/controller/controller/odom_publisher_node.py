...
from controller import differential_drive
...
class Controller(Node):
    ...
    def __init__(self, name):
        ...
        self.chassis = differential_drive.DifferentialChassis(track_width=0.2, wheel_diameter=0.1)
        ...
        self.create_subscription(Twist, '/app/cmd_vel', self.app_cmd_vel_callback, 1)
    ...
    def cmd_vel_callback(self, msg):
        ...
        motors_msg = self.chassis.set_velocity(self.linear_x, self.angular_z)
