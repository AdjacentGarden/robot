...
class YoLov5TRT(object):
    ...
    def __init__(self, engine_file_path, plugin, classes, conf_thresh=0.6, iou_threshold=0.4):
...
if __name__ == "__main__":
    ...
    os.system('sudo /root/ros2_ws/src/example/example/yolov5_detect/reset.sh')
    ...
    # yolov5_wrapper = YoLov5TRT('./best_lr.engine', './libmyplugins_lr.so', classes)
