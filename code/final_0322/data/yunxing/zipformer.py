...
if __name__ == "__main__":
    ...
    # basic params
    parser.add_argument("--encoder_model_path", type=str, default="./model/encoder-epoch-99-avg-1.rknn", help="encoder model path, could be .onnx or .rknn file")
    parser.add_argument("--decoder_model_path", type=str, default="./model/decoder-epoch-99-avg-1.rknn", help="decoder model path, could be .onnx or .rknn file")
    parser.add_argument("--joiner_model_path", type=str, default="./model/joiner-epoch-99-avg-1.rknn", help="joiner model path, could be .onnx or .rknn file")
